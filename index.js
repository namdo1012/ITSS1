...
app.post('/users/signUp', function(req, res) {
	...
	if(req.body.password === req.body.repass) {
		...
		db.write();
		res.send('<script>alert("Sign Up successfully !"); window.location.href = "/users/signIn";</script>');
...
app.post('/users/signIn', function(req, res) {
	...
	if(!user) { // Wrong email
		...
		return;
			...
			res.send('<script>alert("Log In successfully !"); window.location.href = "/users/signIn";</script>');
		}
	}
